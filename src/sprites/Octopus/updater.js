...
const updater = (_this) => () => {
  ...
  _this.game.physics.arcade.collide(_this.game.corals, _this.game.caveLayer)
  _this.game.physics.arcade.collide(_this.game.seaweeds, _this.game.caveLayer)
  _this.game.physics.arcade.collide(_this.game.shells, _this.game.caveLayer)
  _this.game.physics.arcade.collide(_this.game.crabs, _this.game.caveLayer)
  _this.game.physics.arcade.collide(_this.game.protagonistParts, _this.game.caveLayer)
  ...
  if (ringFingersDown(_this) ||
    ...
    _this.game.input.activePointer.leftButton.isDown ||
  ...
  (_this.game.input.activePointer.leftButton.isDown && _this.game.input.activePointer.rightButton.isDown) ||
